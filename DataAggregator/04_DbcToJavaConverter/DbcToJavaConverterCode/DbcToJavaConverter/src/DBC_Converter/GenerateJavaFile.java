	...
	public void generateTheFile(String dbcPath,int selectedIndex) throws IOException {
		...
		for (MessageDescriptor msg : d.getMessages()) {
			...
			for (SignalBitsDesc msg1 : msg.getSignals()) {
				...
				if (msg1.getLengthBit() <= 8) {
					data = "messages." + msg1.getFieldName() + "=(byte)((" + printFunctionBody(msg1) + ") + (byte)(can."
							+ msg.printMsgIDName().toUpperCase() + "_" + msg1.getFieldName().toUpperCase()
							+ "_OFFSET));";
					sourceFile.append(data + "\n");
				} else if (msg1.getLengthBit() <= 16) {
					data = "messages." + msg1.getFieldName() + "=(short)((" + printFunctionBody(msg1) + ") + (short)(can."
							+ msg.printMsgIDName().toUpperCase() + "_" + msg1.getFieldName().toUpperCase()
							+ "_OFFSET));";
					sourceFile.append(data + "\n");
				} else if (msg1.getLengthBit() <= 32) {
					data = "messages." + msg1.getFieldName() + "=(int)((" + printFunctionBody(msg1) + ") + (int)(can."
							+ msg.printMsgIDName().toUpperCase() + "_" + msg1.getFieldName().toUpperCase()
							+ "_OFFSET));";
					sourceFile.append(data + "\n");
				} else {
					data = "messages." + msg1.getFieldName() + "=(long)((" + printFunctionBody(msg1) + ") + (long)(can."
							+ msg.printMsgIDName().toUpperCase() + "_" + msg1.getFieldName().toUpperCase()
							+ "_OFFSET));";
					sourceFile.append(data + "\n");
				}
