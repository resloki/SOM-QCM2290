package com.royalenfield.dataaggregator.DataAggregator.strategicIoLayer;
...
public class SignalPublisher {
    ...
    public void SignalBroadcast(int canid,String signalName,Object data,String formattedTimestamp){
        ...
        broadcastIntent.setAction("com.royalenfield.UARTservice.ENGINEERING_SIGNALS_BROADCAST");
