...
import com.royalenfield.diagcan.iso14229UDS.CrcCalculator.crc32Calculator;
...
public class HexToBin {
    ...
    public ProgramFile convertHexToBinary(Context context, Uri hexFileUri) throws IOException {
        long baseAddress = 0;
        long totalLength = 0;
        long startAddress = -1;
        ...
        try (InputStream inputStream = context.getContentResolver().openInputStream(hexFileUri);
            ...
            return new ProgramFile(totalLength, startAddress, flashingFilePath, crcoutput);
