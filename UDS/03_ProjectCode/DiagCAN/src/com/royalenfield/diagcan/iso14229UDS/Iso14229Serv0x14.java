...
public class Iso14229Serv0x14 extends DiagCanService {
    private static final String serviceName = "service Name: 0x11,";
    private static final byte POSITIVE_RESPONSE = 0x51;


    public Iso14229Serv0x14(ServiceInfo serviceInfo, DiagCanTp CANtp) {
    ...
    public int runService() {
            ...
            requestFrame[3] = (byte) 0xff; //Group of DTC
            requestFrame[4] = (byte) 0xff; //Group of DTC
            requestFrame[5] = (byte) 0xff; //Group of DTC
            ...
            switch (responseFrame[1]) {
                case POSITIVE_RESPONSE:
                    callbackMgr.onDataAvailable(responseFrame, serviceID, 0, null);
                    return 0;
