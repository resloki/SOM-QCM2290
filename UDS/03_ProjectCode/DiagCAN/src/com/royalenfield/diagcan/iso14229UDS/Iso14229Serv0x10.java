 ...
 */
public class Iso14229Serv0x10 extends DiagCanService {
     ...
     */
    public Iso14229Serv0x10(ServiceInfo serviceInfo, DiagCanTp CANtp) {
    ...
    public int runService() {
        ...
        callbackMgr.Log(TAG, processName + " Sending request via ISO_15765tp: " + Arrays.toString(requestFrame));
